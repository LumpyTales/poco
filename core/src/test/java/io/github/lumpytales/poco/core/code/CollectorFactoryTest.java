...
class CollectorFactoryTest {
    ...
    void When_collector_is_generated_Then_expect_class_javadoc() {
        ...
        Assertions.assertThat(result)
                ...
                .isEqualTo(
                        """
                                This class will collect all nested objects of type {@link io.github.lumpytales.poco.core.testclasses.Product} in object of type {@link io.github.lumpytales.poco.core.testclasses.Order}

                                BaseClass: {@link io.github.lumpytales.poco.core.testclasses.Order}
                                ClassToCollect: {@link io.github.lumpytales.poco.core.testclasses.Product}""");
        ...
        Assertions.assertThat(result.methodSpecs)
                ...
                .containsExactly(
                        "@return all objects of type {@link"
                            + " io.github.lumpytales.poco.core.testclasses.Product} from anywhere"
                            + " in base class of type {@link"
                            + " io.github.lumpytales.poco.core.testclasses.Order}");
        Assertions.assertThat(result.methodSpecs)
